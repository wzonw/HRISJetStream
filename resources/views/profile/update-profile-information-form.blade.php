<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="place_of_birth" type="text" class="mt-1 block w-full" wire:model.defer="state.place_of_birth" required autocomplete="place_of_birth" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="civil_status" type="text" class="mt-1 block w-full" wire:model.defer="state.civil_status" required autocomplete="civil_status" />
