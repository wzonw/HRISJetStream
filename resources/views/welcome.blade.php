                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        ...
                        @if (Route::has('dashboard'))
                            <a href="{{ route('dashboard') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">HRIS</a>
                        @endif
                    @endauth
                </div>
            @endif
