...
<div class="flex">
    ...
    <div>
        ...
        <div class="w-[309px] h-[102px] mb-4 relative">
            ...
            <div class="w-[94px] h-[27px] left-[215px] top-[37px] absolute text-center text-white text-2xl font-semibold font-'Inter'">10</div>
    ...
    <div class="w-[599px] h-[594px] my-4 relative">
        <div class="w-[599px] h-[594px] left-0 top-0 absolute bg-white shadow shadow-gray-400 border border-black"></div>
        <div class="font-'Inter'" >
            <div class="w-[558px] h-[57px] left-[16px] top-[17px] absolute bg-indigo-800"></div>
            <div class="w-[172px] h-[33px] left-[39px] top-[30px] absolute text-indigo-50 text-2xl font-bold ">PLM Careers!<br/></div>
            <div class="w-[77px] h-4 left-[33px] top-[93px] absolute text-black text-[15px] font-semibold">Part Time</div>
            <div class="w-[77px] h-4 left-[322px] top-[93px] absolute text-black text-[15px] font-semibold">Full Time</div>4
        </div>
    </div>
</div>
