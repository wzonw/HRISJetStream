<x-admin-layout>
    <div class="ml-3 mt-5">
        <div class="w-[1100px] h-20 bg-gray-100 rounded-lg shadow flex items-center justify-center space-x-96">
            ...
            <div class="">
                ...
                <input class="w-60 h-8 text-center bg-gray-200 rounded" placeholder="Search" >
            </div>
        </div>

        <div class="mt-5 w-[1100px] h-96 bg-gray-100 rounded-lg shadow">
            <div class="pt-5 ml-10 flex space-x-36">
                <p class="h-4 text-black text-sm font-medium font-inter">Employee ID</p>
                <p class="h-4 text-black text-sm font-medium font-inter">Name</p>
                <p class="h-4 text-black text-sm font-medium font-inter">Documents</p>
                <p class="h-4 text-black text-sm font-medium font-inter">Purpose</p>
            </div>
            <div class="w-[1019px] mt-3 ml-8 h-12 border border-black shadow-inner flex items-center justify-end space-x-3">
                <div>
                <button type="text" class="w-10 h-6 bg-green-600 rounded flex justify-center items-center">
